...
/* AUX_MU_IER_REG */
#define ENABLE_TRANSMIT_INTERRUPT(x) (x | 0x1)
#define DISABLE_TRANSMIT_INTERRUPT(x) (x & 0x2)
#define ENABLE_RECEIVE_INTERRUPT(x) (x | 0x2)
#define DISABLE_RECEIVE_INTERRUPT(x) (x & 0x1)
...
/* AUX_MU_LCR_REH */
#define ENABLE_7BIT(x) (x >> 1 << 1)
#define ENABLE_8BIT(x) (x | 0x1)
...
#define ENABLE_RECEIVER(x) (x | 0x1)
#define ENABLE_TRANSMITTER(x) (x | 0x2)
#define ENABLE_AUTO_RECEIVE(x) (x | 0x3)
#define ENABLE_AUTO_TRANSMIT(x) (x | 0x4)

/* AUX_MU_STAT_REG */
#define IS_TRANSMIT_FIFO_FULL(x) ( ! (x & 0x10) )
#define IS_RECEIVE_FIFO_FULL(x) ( ( (x >> 16) & 0x7) <= 8)
